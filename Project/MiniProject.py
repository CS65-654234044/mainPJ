...
def menuSorting():
    ...
    bg = PhotoImage(file="d:/Project/M1.png")
    ...
    def bubble_array():
        ...
        step = [0]
        result.config(text="")
        entry1.delete(0, 'end')  # Clear entry1
    ...
    def update_result(sorted_array, step):
        ...
        entry1.delete(0, 'end')  # Clear entry1
        entry1.insert(0, f"{sorted_array}\n")  # Insert the sorted array into entry1

    def click(event):
        entry.config(state=NORMAL)
        entry.delete(0, END)                      

    label = Label(Sorting,text="Sorting",font=("Minecraft", 20),fg="white",bg="#171111")
    ...
    entry1 = Entry(Sorting, font=("Helvetica", 15))
    entry1.place(relx=0.15, rely=0.6)

    result = Label(Sorting, text="", font=("Helvetica", 12), bg="#171111",fg="white")
...
def menuSearching():#สร้างหน้าต่างSearching
    ...
    labe2 = Label(Searching,text="ค้นหาตัวเลข",font=("Helvetica", 14),fg="white",bg="#171111")
    labe2.place(x=150, y=160)

    labe2 = Label(Searching,text="ผลลัพธ์",font=("Helvetica", 14),fg="white",bg="#171111")
    labe2.place(x=150, y=260)

    add_button = Button(Searching, text="เพิ่มตัวเลข", font=14, command=add_number)
    add_button.place(x=550, y=100)

    displayed_numbers = Label(Searching, font=("Helvetica", 14) ,bg="#171111",fg="white")
    displayed_numbers.place(x=250, y=220)
